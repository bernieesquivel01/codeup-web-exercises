...
// *
    ...
    function sayHelloBye(input, number){
        if (number === 1){
        return "Hello " + input;
        } else {
            return "Bye " + input;
...
//
///* Integer in Range?
// * Create a function that validates whether a number n is within the bounds of lower(a) and upper(b). Return false if n is not an integer.
// *
// * Examples
