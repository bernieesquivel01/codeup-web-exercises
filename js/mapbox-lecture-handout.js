...
//create variable with desired properties

var mapOption1 = {
    container: "map",
    style: "mapbox://styles/mapbox/navigation-day-v1",
    center: [-98.7865, 29.6543],
    zoom: 10,
}
var map = new mapboxgl.Map (mapOption1)
...
var dallasMarker = new mapboxgl.Marker({color: "green", draggable: true})
...
reverseGeocode({lat:29.4260, lng: -98.4861}, mapboxApiKey).then(function)
